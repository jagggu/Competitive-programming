...
/*   Algorithm: 
	...
	1. We need to minimise the max time taken by mouse to reach hole.
	2. As each mouse take only 1 step either left or right. To minimise the
		time it needs to go to the nearest hole.
	 3. So sort the mouse array and holes array so the distance travelled by mouse to reach nearest hole is minimised
*/
